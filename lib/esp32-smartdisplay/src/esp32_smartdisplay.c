...
#ifndef SMARTDISPLAY_TOUCH_READ_PERIOD_MS
#define SMARTDISPLAY_TOUCH_READ_PERIOD_MS 12
#endif
...
// If there is a touch controller defined
  ...
  {
    lv_timer_set_period(touch_read_timer, SMARTDISPLAY_TOUCH_READ_PERIOD_MS);
    log_i("Touch read period set to %d ms", SMARTDISPLAY_TOUCH_READ_PERIOD_MS);
  }
